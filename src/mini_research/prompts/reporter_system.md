...
- Cite sources inline using the format [source title](source url) wherever relevant
- Be factual and grounded in the provided facts; do not invent information
- Highlight key findings, patterns, and any notable gaps
- End with a brief conclusion
- Return plain Markdown only, no JSON wrapper or code fences
